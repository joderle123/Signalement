...
const THERAPIE_MODULE_DATEIEN = {
  // Familie
  'familienzusammensetzung': 'therapiemodul-familienzusammensetzung.html',
  'eltern-kind-beziehung':   'therapiemodul-eltern-kind-beziehung.html',
  'geschwister':             'therapiemodul-geschwister.html',
  'wohnsituation':           'therapiemodul-wohnsituation.html',
  'trennung-scheidung':      'therapiemodul-trennung-scheidung.html',
  'soziales-netzwerk':       'therapiemodul-soziales-netzwerk.html',
  'genogramm':               'therapiemodul-genogramm.html',
  'pflegefamilie':           'therapiemodul-pflegefamilie.html',
  // Emotionen
  'emotionserkennung':       'therapiemodul-emotionserkennung.html',
  'emotionsregulation':      'therapiemodul-emotionsregulation.html',
  'stress-angst':            'therapiemodul-angst.html',
  'angstanfaelle':           'therapiemodul-angstanfaelle.html',
  'wiederkehrende-gedanken': 'therapiemodul-wiederkehrende-gedanken.html',
  'stimmungsextreme':        'therapiemodul-stimmungsextreme.html',
  'impulskontrolle':         'therapiemodul-impulskontrolle.html',
  'wut-aggression':          'therapiemodul-wut-aggression.html',
  'trauer-verlust':          'therapiemodul-trauer-verlust.html',
  'selbstwertgefuehl':       'therapiemodul-selbstwertgefuehl.html',
  'depressive-stimmungen':   'therapiemodul-depressive-stimmungen.html',
  'freude-wohlbefinden':     'therapiemodul-freude-wohlbefinden.html',
  // Soziale Kompetenzen
  'freundschaften':          'therapiemodul-freundschaften.html',
  'einsamkeit':              'therapiemodul-einsamkeit.html',
  'soziale-wahrnehmung':     'therapiemodul-soziale-wahrnehmung.html',
  'konfliktmanagement':      'therapiemodul-konfliktmanagement.html',
  'kommunikation':           'therapiemodul-kommunikation.html',
  'romantische-beziehungen': 'therapiemodul-romantische-beziehungen.html',
  'grenzen-setzen':          'therapiemodul-grenzen-setzen.html',
  'mobbing':                 'therapiemodul-mobbing.html',
  'gruppendynamik':          'therapiemodul-gruppendynamik.html',
  'empathie':                'therapiemodul-empathie.html',
  // Konsum
  'alkohol':                 'therapiemodul-alkohol.html',
  'cannabis':                'therapiemodul-cannabis.html',
  'tabak-ezigarette':        'therapiemodul-tabak-ezigarette.html',
  'gaming':                  'therapiemodul-gaming.html',
  'social-media':            'therapiemodul-social-media.html',
  'gluecksspiel':            'therapiemodul-gluecksspiel.html',
  'selbstmedikation':        'therapiemodul-selbstmedikation.html',
  // Schule & Zukunft
  'schulisches-engagement':       'therapiemodul-schulisches-engagement.html',
  'konzentration-aufmerksamkeit': 'therapiemodul-konzentration-aufmerksamkeit.html',
  'lernstrategien':          'therapiemodul-lernstrategien.html',
  'schulkonflikt':           'therapiemodul-schulkonflikt.html',
  'berufsorientierung':      'therapiemodul-berufsorientierung.html',
  'zukunftsplanung':         'therapiemodul-zukunftsplanung.html',
  'motivation':              'therapiemodul-motivation.html',
  'prüfungsangst':           'therapiemodul-pruefungsangst.html',
  // Gesundheit
  'schlaf':                  'therapiemodul-schlaf.html',
  'ernaehrung':              'therapiemodul-ernaehrung.html',
  'essverhalten':            'therapiemodul-essverhalten.html',
  'koerperbeschwerden':      'therapiemodul-koerperbeschwerden.html',
  'sport-bewegung':          'therapiemodul-sport-bewegung.html',
  'sexualitaet':             'therapiemodul-sexualitaet.html',
  'koerperbild':             'therapiemodul-koerperbild.html',
  'mentale-gesundheit':      'therapiemodul-mentale-gesundheit.html',
  'chronische-erkrankung':   'therapiemodul-chronische-erkrankung.html',
  // Alltag
  'transport':               'therapiemodul-transport.html',
  'finanzen':                'therapiemodul-finanzen.html',
  'haushalt':                'therapiemodul-haushalt.html',
  'freizeit':                'therapiemodul-freizeit.html',
  'mediennutzung':           'therapiemodul-mediennutzung.html',
  'ehrenamt':                'therapiemodul-ehrenamt.html',
  // Recht
  'jugendrecht':             'therapiemodul-jugendrecht.html',
  'jugendschutz':            'therapiemodul-jugendschutz.html',
  'soziale-dienste':         'therapiemodul-soziale-dienste.html',
  'polizei-justiz':          'therapiemodul-polizei-justiz.html',
  'buergerrechte':           'therapiemodul-buergerrechte.html',
  'diskriminierung':         'therapiemodul-diskriminierung.html',
  // Identität
  'selbstbild':              'therapiemodul-selbstbild.html',
  'werte-moral':             'therapiemodul-werte-moral.html',
  'kulturelle-identitaet':   'therapiemodul-kulturelle-identitaet.html',
  'geschlechtsidentitaet':   'therapiemodul-geschlechtsidentitaet.html',
  'spiritualitaet':          'therapiemodul-spiritualitaet.html',
  'zugehoerigkeit':          'therapiemodul-zugehoerigkeit.html',
  'lebenssinn':              'therapiemodul-lebenssinn.html',
  // Krise & Trauma
  'krisenintervention':           'therapiemodul-krisenplan.html',
  'trauma':                  'therapiemodul-trauma.html',
  'dissoziative-erfahrungen':'therapiemodul-dissoziative-erfahrungen.html',
  'wahrnehmungsveraenderungen':'therapiemodul-wahrnehmungsveraenderungen.html',
  'suizidpraevention':       'therapiemodul-krisenplan.html',
  'selbstverletzung':        'therapiemodul-selbstverletzung.html',
...
// ============================================================
// Fachkraft-Modul-Dateien (HTML) – Zuordnung themaId → Dateiname
// ============================================================
const FACHKRAFT_MODULE_DATEIEN = {
  ...
  // Emotionen
  'emotionserkennung':       'emotionserkennung.html',
  'emotionsregulation':      'emotionsregulation.html',
  'stress-angst':            'stress-angst.html',
  'angstanfaelle':           'angstanfaelle.html',
  'wiederkehrende-gedanken': 'wiederkehrende-gedanken.html',
  'stimmungsextreme':        'stimmungsextreme.html',
  'impulskontrolle':         'impulskontrolle.html',
  'wut-aggression':          'wut-aggression.html',
  'trauer-verlust':          'trauer-verlust.html',
  'selbstwertgefuehl':       'selbstwertgefuehl.html',
  'depressive-stimmungen':   'depressive-stimmungen.html',
  'freude-wohlbefinden':     'emotionserkennung.html',
  // Soziale Kompetenzen
  'freundschaften':          'freundschaft.html',
  'einsamkeit':              'einsamkeit.html',
  'soziale-wahrnehmung':     'soziale-wahrnehmung.html',
  'konfliktmanagement':      'kommunikation.html',
  'kommunikation':           'kommunikation.html',
  'romantische-beziehungen': 'romantische-beziehungen.html',
  'grenzen-setzen':          'kommunikation.html',
  'mobbing':                 'mobbing.html',
  'gruppendynamik':          'gruppendynamik.html',
  'empathie':                'empathie.html',
  // Konsum
  'alkohol':                 'alkohol.html',
  'cannabis':                'cannabis.html',
  'tabak-ezigarette':        'konsum-tabak.html',
  ...
  'berufsorientierung':      'zukunftsplanung.html',
  'zukunftsplanung':         'zukunftsplanung.html',
  ...
  'chronische-erkrankung':   'chronische-erkrankung.html',
  // Alltag
  'transport':               'transport.html',
  'finanzen':                'finanzen.html',
  'haushalt':                'haushalt.html',
  'freizeit':                'freizeit.html',
  'mediennutzung':           'soziale-medien-gaming.html',
  'ehrenamt':                'ehrenamt.html',
  // Recht
  'jugendrecht':             'jugendrecht.html',
  'jugendschutz':            'jugendrecht.html',
  'soziale-dienste':         'soziale-dienste.html',
  'polizei-justiz':          'polizei-justiz.html',
  'buergerrechte':           'polizei-justiz.html',
  'diskriminierung':         'diskriminierung.html',
  // Identität
  'selbstbild':              'identitaet.html',
  'werte-moral':             'identitaet.html',
  'kulturelle-identitaet':   'identitaet.html',
  'geschlechtsidentitaet':   'identitaet.html',
  'spiritualitaet':          'spiritualitaet.html',
  'zugehoerigkeit':          'identitaet.html',
  'lebenssinn':              'identitaet.html',
  // Krise & Trauma
  'krisenintervention':      'krisenintervention.html',
  'trauma':                  'trauma.html',
  'dissoziative-erfahrungen':'dissoziative-erfahrungen.html',
  'wahrnehmungsveraenderungen':'wahrnehmungsveraenderungen.html',
  'suizidpraevention':       'suizidpraevention.html',
  'selbstverletzung':        'selbstverletzung.html',
...
const FIVEP_HILFE = {
  presenting: {
    ...
    vorgehen: 'So gehst du vor: 1) Schau dir das Screening-Ergebnis an — welche Bereiche sind auffällig? 2) Beschreibe die Probleme in konkreten Verhaltensbeispielen (nicht „ist aggressiv" sondern „schlägt 2x pro Woche Mitschüler in der Pause"). 3) Seit wann? Wie oft? Wie schwer? 4) Ordne nach Dringlichkeit — was muss zuerst bearbeitet werden?',
    zweck: 'Das Presenting ist dein STARTPUNKT. Es definiert, woran du arbeitest und woran du später Fortschritt misst.',
  },
  predisposing: {
    ...
    vorgehen: 'So gehst du vor: 1) Lies die Akte / Anamnese — was ist in der Kindheit passiert? 2) Gibt es Diagnosen (ADHS, LRS, Trauma)? 3) Wie ist die Familiensituation (Trennung, Gewalt, psychische Erkrankungen der Eltern)? 4) Welche früheren Erfahrungen haben das aktuelle Problem vorbereitet?',
    zweck: 'Predisposing erklärt die VERLETZLICHKEIT. Es hilft dir zu verstehen, warum dieser Jugendliche unter diesen Umständen Probleme entwickelt hat, während andere es nicht tun.',
  },
  precipitating: {
    ...
    vorgehen: 'So gehst du vor: 1) Frage den Jugendlichen: „Wann hat es angefangen schlimmer zu werden?" 2) Was ist in diesem Zeitraum passiert? (Umzug, Streit, Verlust, Schulwechsel...) 3) Gibt es einen klaren Zusammenhang zwischen Ereignis und Symptombeginn? 4) Manchmal gibt es mehrere Auslöser — alle auflisten.',
    zweck: 'Der Auslöser zeigt dir den KONTEXT. Wenn der Auslöser noch aktiv ist (z.B. Mobbing geht weiter), muss er direkt adressiert werden.',
  },
  perpetuating: {
    ...
    vorgehen: 'So gehst du vor: 1) Frage dich: „Was müsste sich ändern, damit es besser wird?" 2) Prüfe: Vermeidet der Jugendliche etwas? (Vermeidung ist DER häufigste aufrechterhaltende Faktor!) 3) Gibt es einen Teufelskreis? (z.B. Rückzug → Einsamkeit → mehr Rückzug) 4) Spielt die Umgebung eine Rolle? (Familie, Schule, Peers) 5) Gibt es einen sekundären Gewinn?',
    zweck: 'Perpetuating zeigt dir die HEBELPUNKTE. Hier setzt deine Intervention an! Wenn du den aufrechterhaltenden Kreislauf unterbrichst, beginnt die Besserung.',
  },
  protective: {
    ...
    vorgehen: 'So gehst du vor: 1) Schau dir die Stärken-Bewertung an — was ist hoch bewertet? 2) Welche Menschen stehen dem Jugendlichen nah? 3) Hat er Hobbys, Interessen, Talente? 4) Was hat ihm in früheren Krisen geholfen? 5) Was macht er GUT — auch wenn er gerade Probleme hat?',
    zweck: 'Protective ist dein WERKZEUGKASTEN. Diese Stärken nutzt du in der Intervention. Baue auf dem auf, was da ist — nicht nur auf dem, was fehlt.',
  },
};
